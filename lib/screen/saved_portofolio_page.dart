...
class SavedPortofolioPage extends StatelessWidget {
  const SavedPortofolioPage({super.key});
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, userSnapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Belum ada portofolio tersimpan',
          ...
          return FutureBuilder<List<Portofolio>>(
            future: _portofolioService.getSavedPortfolios(savedIds),
